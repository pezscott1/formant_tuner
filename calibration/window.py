...
class CalibrationWindow(QMainWindow):
    ...
    def __init__(self, profile_name, voice_type="bass",
        ...
        # Shared engine
        self.engine = engine
        # Ensure the engine's mic stream is running
        if hasattr(self.engine, "start_stream"):
            try:
                self.engine.start_stream()
                print("[CALIBRATION] Started shared mic stream")
            except Exception as e:
                print("[CALIBRATION] Stream already running or failed:", e)
